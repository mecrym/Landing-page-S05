...
export default function Uml() {
    return (
        <section id="uml" className="w-full py-20 px-4 sm:px-16 lg:px-8 bg-slate-950 overflow-x-hidden">
                ...
                <div className="flex flex-col items-center space-y-12">
                    ...
                    <div className="text-center max-w-4xl animate-in slide-in-from-bottom duration-700">
                        ...
                        <p className='text-gray-400 text-lg leading-relaxed'>
                            O Diagrama de Classes UML define a arquitetura do sistema, detalhando como os objetos (Candidato, Vaga, Empresa) se relacionam e trocam informações para garantir a consistência da aplicação.
                        </p>
                    </div>
